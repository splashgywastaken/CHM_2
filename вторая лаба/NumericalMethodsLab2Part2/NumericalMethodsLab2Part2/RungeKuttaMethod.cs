...
namespace NumericalMethodsLab2Part2
{
    internal class RungeKuttaMethod
    {
        ...
        private double[] Zn { get; set; }                     // Результирующий вектор z размера n
        ...
        public int GetResult()
        {
            ...
            do
            {
                ...
                currentErrorY = FindError(Yn, Y2N);
                currentErrorZ = FindError(Zn, Z2N);
        ...
        // Поиск погрешности
        public static double FindError(IEnumerable<double> n, IEnumerable<double> n2)
        {
